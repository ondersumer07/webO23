<script>
	export let company = '';
	export let date_of_work = '';
	export let role = '';
	export let description = '';
	export let link = 'javascript:void(0)';
</script>

<!-- Each experience slot -->
<div class="py-5 md:grid md:grid-cols-3">
	<div class="md:hidden">
		<h3 class="h2 text-3xl">{role}</h3>
	</div>
	<div
	...
	>
		<h3 class="h4 md:h3 hover:underline md:mr-5"><a target="_blank" href={link}>{company}</a></h3>
