...
`}
		></CodeBlock>
		<p>
			You can customize these as you like. I use a weather background for my default backgroundUrl,
...
`}
		...
		<p>
			...
			of musicCard. If you're going to use animated SVG files, be careful to use CSS animations for embedded
			SVGs and JS animations for open SVGs.
		</p>

		<div>
			<h4 class="h4 underline decoration-2 md:h3">Final Notes</h4>
			<p>
				Even though simple, I like the idea of showing people a hint of my music taste. If you also
				do, you can easily install musicCard to share! Another thing, huge shout-out to <a
					class="underline transition-all hover:font-bold"
