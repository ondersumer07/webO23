...
<div class="flex flex-col space-y-4 text-justify">
	<p>
		Welcome to the docs of musicCard. This component showcases your music to others in your website.
		You can <a
	...
	<div>
		...
		<p>
			This is a simple component that shows your last music data, it can fetch the data from various
			platforms thanks to last.fm. You can connect all your music apps, and it will showcase your
			latest activity. It has two states: "Now Playing" and "Last Played." Here's how they look:
		</p>
	</div>
	...
	<p>
		Besides the showcase, you can also click on the card to visit the song's last.fm page. Here's
		the demo:
	</p>
	<div class="flex w-full justify-center">
		<div class="grid w-3/4 grid-cols-1 items-center">
...
npm install"
	...
	<p>
		...
		CSS.Thanks to them, developing your website is way easier and faster. However, if you don't want
		to install them, you can take this work as an example to create your own component.
	</p>
	<p>
...
LAST_FM_API_KEY=YOUR_API_KEY_HERE"
	...
	<div>
		...
		<p>
			Now that you've set up the project correctly, you need to set up your account and adjust your
			username. Otherwise it won't work properly.
		</p>
	</div>
	<div>
		<h5 class="h5">Default variables</h5>
		<p>
			If you'd like, you can change the example variables I've put in. I don't think it's necessary
			though.
		</p>
	</div>
...
`}
	...
	<div>
		...
		<p>After that, you should adjust your Javascript file to put in your last.fm username. Otherwise it'll fetch "example" user's data.</p>
	</div>
...
`}
	...
	<p>
		You can adjust the "Last Played" icon by replacing the SVG code. Remember to put in <code>fill="#FBE7D1"</code> to your icon, so it will show up in the right color.
	</p>
...
<p>
	You can adjust the "Now Playing" icon by replacing this variable in the <code>script</code> part of musicCard. If you're going to use animated SVG files, be careful to use CSS animations for embedded SVGs and JS animations for open SVGs.
</p>

	<div>
		<h4 class="h4 underline decoration-2 md:h3">Final Notes</h4>
		<p>
			Even though simple, I like the idea of showing people a hint of my music taste. If you also do, you can easily install musicCard to share! Another thing, huge shout-out to <a
				class="underline transition-all hover:font-bold"
				href="https://github.com/burraksumer"
				target="_blank">Burak Sümer</a
			> as I discovered last.fm API thanks to him. You can use and change musicCard however you like, and I hope you'll have as much fun as I did! If you have any questions regarding this, don't hesitate to contact me via email. Finally, don't forget to watch out for what you're listening, people are looking!
		</p>
	</div>
</div>
