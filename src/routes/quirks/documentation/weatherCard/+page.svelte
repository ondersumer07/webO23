...
<!-- Page Title -->
<svelte:head>
	<title>weatherCard | Önder Sümer</title>
</svelte:head>
...
`}
		...
		<p>
			...
			URL creation. If you don't change this variable, the data that is showing will be Istanbul's data.
		</p>
...
`}
		...
		<div>
			...
			<p>
				...
				main page file. You can enter a timezone directly, or fetch it from your database, or leave
				it as is if you're living in Europe.
			</p>
		</div>
		<CodeBlock
			language="Svelte"
...
`}
		></CodeBlock>
		<p>
			You can pretty much change everything about the look of your map. I prefer a simpler map, but
			if you'd like a more complex one, you can definitely have one.
		</p>
