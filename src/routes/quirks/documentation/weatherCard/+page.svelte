...
<div class="flex flex-col space-y-4 text-justify">
	<p>
		Welcome to the docs of weatherCard. This is a component you can use freely to show others your
		city's weather data. You can <a
	...
	<div class="card flex flex-row items-center space-x-4 p-4">
		...
		<p>
			...
			>, so you will need an API key from them. You can use their free plan if you plan on building
			a small project. Also, you will need a key for
			<a
				class="underline transition-all hover:font-bold"
	...
	<div>
		...
		<p>
			This component supports every possible weather condition mentioned in Open Weather API. It has
			7 different animated backgrounds for various situations: Clear(Morning), Clear(Night),
			Clouds(Morning), Clouds(Night), Rain, Thunderstorm and Snow. Even if the title isn't directly
			supported, it's replaced by the most similar weather condition. Here are those animations
			(except rain):
		</p>
	</div>

	<div class="flex w-full justify-center">
		<div class="grid w-3/4 grid-cols-2 items-center">
	...
	<p>
		Besides the weather condition, weatherCard also has a popup feature that shows the geographical
		location of your city. It uses Google's Maps Static API which is also customizable. We will dive
		deeper into it later. Here's how the maps function work:
	</p>
	<div class="flex w-full justify-center">
		<div class="grid w-3/4 grid-cols-2 items-center">
...
npm install"
	></CodeBlock>
	<p>
		Now you will have a Skeleton project that works with SvelteKit and also includes Tailwind CSS
		and Floating UI. It might sound like much, but it makes development way easier. If you don't
		want to use those libraries, you can take this work as an example and create the component
		yourself from scratch.
	</p>
	<p>
		To get the project working, create a <code>.env</code> file in your root directory. Inside it should
		look like this:
	</p>
	<CodeBlock
		language="Bash"
...
`}
	></CodeBlock>
	<p>
		You can customize these as you like. Just make sure they're valid. I leave the mapsURL empty in
		purpose. Because even if it's like this, it will still work, just won't show the popup. I
...
`}
	></CodeBlock>
	<p>
		The <code>currentCity</code> is the variable used in during both fetching weather data and maps URL
		creation. If you don't change this variable, the data that is showing will be Istanbul's data.
	</p>
...
`}
	...
	<div>
		...
		<p>
			If you're outside of Europe, or want to use a static timezone, you can change it in your main
			page file. You can enter a timezone directly, or fetch it from your database, or leave it as
			is if you're living in Europe.
		</p>
	</div>
	<CodeBlock
		language="Svelte"
...
{/await}`}
	></CodeBlock>
	<p>
		This code assumes that you're in Europe and that Javascript recognizes your city as a timezone.
		You can adjust <code>timezoneCity</code> value to fit your needs.
	</p>
	<p>Finally, it should all be working! Hooray!</p>
	<div>
		<h5 class="h5">Adding other weather conditions (optional)</h5>
		<p>
			If you want, you can add or remove weather conditions to suit your needs. Only thing you need
			to do is upload your new background file to <code>/static/weatherBg</code> and link it.
		</p>
	</div>
	<CodeBlock
		language="Javascript"
...
`}
	></CodeBlock>
	<p>
		You can pretty much change everything about the look of your map. I prefer a simpler map, but if
		you'd like a more complex one, you can definitely have one.
	</p>
	...
	<div>
		...
		<p>
			I've had a lot of fun developing this component for my website. I'm using free versions of all
			these APIs, but you can scale it if you wish to. Huge shout-out to <a
				class="underline transition-all hover:font-bold"
				href="https://github.com/burraksumer"
				target="_blank">Burak Sümer</a
			> as he was with me the whole process. You can use and change weatherCard however you like, and
			I hope you'll have as much fun as I did! If you have any questions regarding this, don't hesitate
			to contact me via email. Lastly, I hope it's sunny where you live!
		</p>
	</div>
</div>
